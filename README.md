# Опис проекту
Реалізація системи для управління замовленнями в магазині техніки. 

# Інструкція для запуску та тестування коду
...
# Юзери
1) Юзери:
   - seller (з правами seller_permission)
   - cashier (з правами cashier_permission)
   - accountant (з правами accountant_permission)
